...
export const CONFIG = {
  ...
  CHATWOOT_BASE_URL: process.env.CHATWOOT_BASE_URL || 'https://chatwoot.projectvalemind.com',
  CHATWOOT_API_TOKEN: process.env.CHATWOOT_API_TOKEN || '',
  CHATWOOT_ACCOUNT_ID: parseInt(process.env.CHATWOOT_ACCOUNT_ID || '1', 10),
  EVOLUTION_API_URL: process.env.EVOLUTION_API_URL || 'https://evo.realmercado.com.br',
