...
process.env.CHATWOOT_INBOX_MAP = JSON.stringify({
  9: { organization_id: "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb", branch_id: "cccccccc-cccc-cccc-cccc-cccccccccccc", channel: "whatsapp" },
});
